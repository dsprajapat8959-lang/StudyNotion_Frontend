...
export default function SubSectionModal({
  ...
  const onSubmit = async (data) => {
    ...
    formData.append("timeDuration", data.lectureTimeDuration)
        ...
        >
          ...
          <div className="flex flex-col space-y-2">
            ...
            <input
              ...
              className="form-style w-full  bg-richblack-700 rounded pl-2"
            />
            {errors.lectureTitle && (
          ...
          <div className="flex flex-col space-y-2">
            ...
            <textarea
              ...
              className="form-style resize-x-none min-h-[130px] w-full bg-richblack-700 rounded "
            />
            {errors.lectureDesc && (
              <span className="ml-2 text-xs tracking-wide text-pink-200">
